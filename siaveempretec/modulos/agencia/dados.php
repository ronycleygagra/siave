...
$ag = new Agencia($_POST ["di"], $_POST ["df"], $_POST ["codagencia"],$projetosagencia);
$satisfacao = $ag->satisfacao();
$satisfacaoentrevistador = $ag->satisfacaoentrevistador();
$satisfacaofacilitadores = $ag->satisfacaofacilitadores();
$infraestrutura = $ag->infraestrutura();
$aplicabilidade = $ag->aplicabilidade();
$promocaonps = $ag->promocaonps();
$conhecimento = $ag->conhecimento();
?>
